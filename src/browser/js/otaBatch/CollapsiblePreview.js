...
// Copied from config-editor-tools src/components/CollapsiblePreview.js
// (purely presentational; copied to avoid a tools version bump).
// Subtle accordion-style toggle for partial config previews - light gray
// text with an expand/collapse arrow. The Download JSON action sits at the
